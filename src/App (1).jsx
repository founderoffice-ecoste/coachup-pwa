...
function FourPhaseReport({ fourPhase }) {
  ...
  const overallScore = Math.round(fourPhase.four_phase_overall || 0);
  ...
  return (
    <Card style={{ marginBottom: 12 }}>
      ...
      {phases.map((phase) => {
        ...
        const phaseScore = Math.round(d.score || 0);
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 20 }}>
        {[
          ...
          { screen: S.OBJECTIONS, icon: "OH", title: "Objection Handler", sub: "Scripts & responses", accent: T.purple },
...
function ObjectionHandlerScreen({ onBack }) {
  ...
  return (
    <div>
      <button onClick={onBack} style={{ background: "none", border: "none", color: T.textSub, cursor: "pointer", marginBottom: 16, fontSize: 13 }}>← Back</button>
      <div style={{ fontSize: 20, fontWeight: 900, color: T.text, marginBottom: 4 }}>Objection Handler</div>
